...
Значення and має менший пріоритет ніж &&.
    ...
    $c = 2332 and 1;
    echo $c; // 1
Виведе 2332, тому що and має нижчий пріоритет ніж "=" (на відміну від &&, тому при використанні "and" потрібно застосовувати дужки) і відповідно $c присвоїться відразу 1, незалежно що буде у другому операнді. І так для всіх інших операторів.
